...
class TimetableSlot(Base, SchoolMixin):
    ...
    slot_type = Column(String(20), nullable=False, default="LESSON",
    ...
    __table_args__ = (
        UniqueConstraint("school_id", "period_index", "slot_type",
                         name="uix_school_period_type"),
...
class TimetableScheduleInstance(Base, SchoolMixin):
    ...
    # ⚡ 工业级高能索引
    __table_args__ = (
        UniqueConstraint("class_id", "date", "slot_id",
                         name="uix_class_date_slot"),
