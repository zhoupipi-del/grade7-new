...
class CohortStatistics(BaseModel):
    ...
    clip_lower: Optional[float] = None   # μ_long − clip_sigma × σ_long
    clip_upper: Optional[float] = None   # μ_long + clip_sigma × σ_long
...
class DimensionResult(BaseModel):
    ...
    growth_vector: Optional[float] = None   # Δz 增长向量
...
class ApprovalChain(BaseModel):
    ...
    total_timeout_hours: Optional[int] = None
