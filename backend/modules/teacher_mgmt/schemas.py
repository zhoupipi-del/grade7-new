...
class TeacherCreate(BaseModel):
    ...
    subject: Optional[str] = Field(None, max_length=50, description="主任教科目")
    employee_no: Optional[str] = Field(None, max_length=30, description="工号")
    # TeacherExtension 字段 (可选)
    title: Optional[str] = Field(None, description="职称")
    hired_at: Optional[str] = Field(None, description="入职日期 YYYY-MM-DD")
    ...
    max_weekly_hours: Optional[int] = Field(None, ge=0, description="周课时上限")
...
class TeacherExtensionCreate(BaseModel):
    ...
    qualifications: Optional[List[str]] = Field(None, description="资质证书列表")
    education: Optional[str] = Field(None, description="最高学历")
    major: Optional[str] = Field(None, max_length=50)
    graduate_school: Optional[str] = Field(None, max_length=100)
...
class TeacherExtensionOut(BaseModel):
    ...
    homeroom_grade: Optional[str] = None
    is_active: bool = True
...
class TeacherListItem(BaseModel):
    ...
    phone: Optional[str] = None                # 来自 User
    employee_no: Optional[str] = None          # 来自 Teacher
    subject: Optional[str] = None              # 来自 Teacher
    title: Optional[str] = None                # 来自 TeacherExtension
    is_homeroom: bool = False                  # 来自 Teacher
    homeroom_class_id: Optional[int] = None    # 班主任班级ID
    homeroom_class_name: Optional[str] = None  # 班主任班级名
    subjects_taught: List[str] = []            # 任教科目列表
    max_weekly_hours: Optional[int] = None     # 周课时上限
    is_active: bool = True
...
class TeacherDetailOut(BaseModel):
    ...
    extension: Optional[TeacherExtensionOut] = None
...
class WorkloadOut(BaseModel):
    ...
    head_teacher_class_id: Optional[int] = None
    extra_duties: Optional[Any] = None
    total_workload_score: Optional[float] = None
    notes: Optional[str] = None
    created_at: datetime
...
class TeacherRoleAssignmentCreate(BaseModel):
    ...
    scope_id: Optional[int] = Field(None, description="作用域ID, school级为NULL")
    expires_at: Optional[str] = Field(None, description="过期时间 YYYY-MM-DDTHH:MM:SS")
...
class EffectiveRoleOut(BaseModel):
    ...
    scope_type: str
    scope_id: Optional[int] = None
    scope_name: Optional[str] = None   # 解析后的作用域名称 (如"初一"/"2501班")
    is_active: bool = True
...
class EffectiveRolesOut(BaseModel):
    ...
    workload_profile: Optional[dict] = None   # 排课引擎供给侧数据
    permission_scopes: Optional[dict] = None  # 审批流权限切面摘要
