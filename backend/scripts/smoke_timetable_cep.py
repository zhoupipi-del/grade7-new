...
DATABASE_URL = get_db_url_for_script()
...
async def smoke():
    ...
    async with SessionLocal() as db:
        ...
        print(
            f"[TEST1] 09:15 -> in_lesson={ctx1['in_lesson']} period={ctx1['period_index']} subject={ctx1['subject_id']} teacher={ctx1['teacher_id']}"
        )
        ...
        print(
            f"[TEST4] 12:30 -> in_lesson={ctx2['in_lesson']} weight=x{w2} ctx={ctx2['context_desc']} PASSED"
        )
